...
function DetailsContextProvider(props) {
    ...
    const [resume, setResume] = useState(
        JSON.parse(localStorage.getItem("resumeLocal")) || Resume);
    ...
    const value = { resume, clearResume, updateHeader, updateEducation, updateSkills, updateInterests, updateContact, updateTemplate, updateImage, updateTheme }
